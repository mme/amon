...
pub struct Hello {
    pub role: Role,
    pub protocol: u32,
    /// Version of the gaze binary on the connecting side.
    pub version: String,
}
...
pub struct HelloResult {
    pub protocol: u32,
    /// Version of the gaze binary running the daemon. A client with a newer
...
pub struct ReportState {
    /// The `GAZE_AGENT_ID` the hook was given.
    pub agent_id: String,
    /// Which integration produced this, e.g. `gaze:claude`.
    pub source: String,
    pub agent: String,
