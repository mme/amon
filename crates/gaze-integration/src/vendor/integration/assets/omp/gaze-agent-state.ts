...
// Upstream: https://github.com/ogulcancelik/herdr/blob/514e4465ee33d4d81682d06ee2934483982a54ed/src/integration/assets/omp/herdr-agent-state.ts
...
const idleDebounceMs = parseDurationEnv("GAZE_OMP_IDLE_DEBOUNCE_MS", 250);
const retryGraceMs = parseDurationEnv("GAZE_OMP_RETRY_GRACE_MS", 2500);
...
export default function (pi) {
  ...
  pi.events.on("gaze:blocked", (data) => {
    if (!rootSession) {
      return;
    }
    if (!data?.active) {
