...
// Upstream: https://github.com/ogulcancelik/herdr/blob/514e4465ee33d4d81682d06ee2934483982a54ed/src/integration/version.rs
...
pub(crate) fn enforce_agent_version(
    ...
    if found < required {
        return Err(io::Error::other(format!(
            "{label} {}.{}.{} is too old: gaze hooks require {label} {min} or newer. upgrade {label}, then re-run install",
            found.0,
            found.1,
            found.2,
