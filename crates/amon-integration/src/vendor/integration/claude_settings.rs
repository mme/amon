...
// Upstream: https://github.com/ogulcancelik/herdr/blob/095f1337d6502081658973ae3487dee8c6b34e1a/src/integration/claude_settings.rs
...
mod tests {
    ...
    fn paths() -> (&'static Path, &'static Path) {
        (
            ...
            Path::new("/home/test/.claude/hooks/amon-agent-state.sh"),
        )
    }
