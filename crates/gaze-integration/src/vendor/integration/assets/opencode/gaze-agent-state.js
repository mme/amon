...
// Upstream: https://github.com/ogulcancelik/herdr/blob/514e4465ee33d4d81682d06ee2934483982a54ed/src/integration/assets/opencode/herdr-agent-state.js
...
// GAZE_INTEGRATION_ID=opencode
// GAZE_INTEGRATION_VERSION=9

import net from "node:net";

const SOURCE = "gaze:opencode";
...
function reportSession(sessionID, sessionStartSource) {
  ...
  return request("agent.report_session", params);
}
    ...
    event: async ({ event }) => {
      ...
      switch (type) {
        case "session.created":
          ...
          // creates are dropped above). Signal it so gaze replaces the pane's
