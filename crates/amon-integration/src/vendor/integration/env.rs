...
// Upstream: https://github.com/ogulcancelik/herdr/blob/095f1337d6502081658973ae3487dee8c6b34e1a/src/integration/env.rs
...
pub(crate) const AMON_AGENT_ID_ENV_VAR: &str = "AMON_AGENT_ID";
pub(crate) const AMON_TAB_ID_ENV_VAR: &str = "AMON_TAB_ID";
pub(crate) const AMON_WORKSPACE_ID_ENV_VAR: &str = "AMON_WORKSPACE_ID";
...
pub(crate) fn apply_pane_base_env(cmd: &mut CommandBuilder) {
    ...
    if let Ok(executable) = std::env::current_exe() {
        cmd.env("AMON_BIN_PATH", executable);
    }
}
...
pub(crate) fn grok_dir() -> io::Result<PathBuf> {
    // GROK_CONFIG_DIR is a amon-level override only (primarily a test
