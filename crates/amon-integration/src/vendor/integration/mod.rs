...
const DEVIN_HOOK_INSTALL_NAME: &str = "amon-agent-state.sh";
const DEVIN_HOOK_ASSET: &str = include_str!("assets/devin/amon-agent-state.sh");
...
const CURSOR_HOOK_INSTALL_NAME: &str = "amon-agent-state.sh";
const CURSOR_HOOK_ASSET: &str = include_str!("assets/cursor/amon-agent-state.sh");
const CURSOR_INTEGRATION_VERSION: u32 = 1;
const MASTRACODE_HOOK_INSTALL_NAME: &str = "amon-agent-state.sh";
const MASTRACODE_HOOK_ASSET: &str = include_str!("assets/mastracode/amon-agent-state.sh");
...
const GROK_HOOK_INSTALL_NAME: &str = "amon-agent-state.sh";
const GROK_HOOK_CONFIG_INSTALL_NAME: &str = "amon.json";
const GROK_HOOK_ASSET: &str = include_str!("assets/grok/amon-agent-state.sh");
