...
// Upstream: https://github.com/ogulcancelik/herdr/blob/514e4465ee33d4d81682d06ee2934483982a54ed/src/detect/mod.rs
...
pub fn session_identity_only_integration(source: &str, agent_label: &str) -> bool {
    (source, agent_label) == ("amon:hermes", "hermes")
}
...
mod tests {
    ...
    fn hermes_session_integration_leaves_state_to_screen_detection() {
        assert!(!full_lifecycle_hook_authority("amon:hermes", "hermes"));
        assert!(session_identity_only_integration("amon:hermes", "hermes"));
