...
// Upstream: https://github.com/ogulcancelik/herdr/blob/095f1337d6502081658973ae3487dee8c6b34e1a/src/integration/assets/opencode/herdr-agent-state.test.ts
...
beforeEach(() => {
  ...
  process.env.AMON_SOCKET_PATH = "test.sock";
  process.env.AMON_AGENT_ID = "test:p1";
});

async function loadPlugin() {
  importCounter += 1;
  const { HerdrAgentStatePlugin } = await import(`./amon-agent-state.js?test=${importCounter}`);
