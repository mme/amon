...
// Upstream: https://github.com/ogulcancelik/herdr/blob/514e4465ee33d4d81682d06ee2934483982a54ed/src/integration/mod.rs
...
pub(crate) use env::{
    apply_pane_base_env, GAZE_AGENT_ID_ENV_VAR, GAZE_TAB_ID_ENV_VAR, GAZE_WORKSPACE_ID_ENV_VAR,
};
...
const PI_EXTENSION_INSTALL_NAME: &str = "gaze-agent-state.ts";
const PI_EXTENSION_ASSET: &str = include_str!("assets/pi/gaze-agent-state.ts");
const PI_INTEGRATION_VERSION: u32 = 7;
const OMP_EXTENSION_INSTALL_NAME: &str = "gaze-omp-agent-state.ts";
const OMP_EXTENSION_ASSET: &str = include_str!("assets/omp/gaze-agent-state.ts");
const OMP_INTEGRATION_VERSION: u32 = 7;
const CLAUDE_HOOK_INSTALL_NAME: &str = if cfg!(windows) {
    "gaze-agent-state.ps1"
} else {
    "gaze-agent-state.sh"
};
const CLAUDE_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/claude/gaze-agent-state.ps1")
} else {
    include_str!("assets/claude/gaze-agent-state.sh")
};
...
const CODEX_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/codex/gaze-agent-state.ps1")
} else {
    include_str!("assets/codex/gaze-agent-state.sh")
};
...
const KIMI_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/kimi/gaze-agent-state.ps1")
} else {
    include_str!("assets/kimi/gaze-agent-state.sh")
};
const KIMI_INTEGRATION_VERSION: u32 = 6;
const KIMI_CONFIG_BLOCK_BEGIN: &str = "# >>> gaze kimi integration";
const KIMI_CONFIG_BLOCK_END: &str = "# <<< gaze kimi integration";
...
const COPILOT_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/copilot/gaze-agent-state.ps1")
} else {
    include_str!("assets/copilot/gaze-agent-state.sh")
};
...
const DEVIN_HOOK_INSTALL_NAME: &str = "gaze-agent-state.sh";
const DEVIN_HOOK_ASSET: &str = include_str!("assets/devin/gaze-agent-state.sh");
...
const DROID_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/droid/gaze-agent-state.ps1")
} else {
    include_str!("assets/droid/gaze-agent-state.sh")
};
...
const OPENCODE_PLUGIN_INSTALL_NAME: &str = "gaze-agent-state.js";
const OPENCODE_PLUGIN_ASSET: &str = include_str!("assets/opencode/gaze-agent-state.js");
const OPENCODE_INTEGRATION_VERSION: u32 = 9;
const KILO_PLUGIN_INSTALL_NAME: &str = "gaze-agent-state.js";
const KILO_PLUGIN_ASSET: &str = include_str!("assets/kilo/gaze-agent-state.js");
const KILO_INTEGRATION_VERSION: u32 = 4;
const HERMES_PLUGIN_INSTALL_NAME: &str = "gaze-agent-state";
...
const QODERCLI_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/qodercli/gaze-agent-state.ps1")
} else {
    include_str!("assets/qodercli/gaze-agent-state.sh")
};
...
const CURSOR_HOOK_INSTALL_NAME: &str = "gaze-agent-state.sh";
const CURSOR_HOOK_ASSET: &str = include_str!("assets/cursor/gaze-agent-state.sh");
const CURSOR_INTEGRATION_VERSION: u32 = 1;
const MASTRACODE_HOOK_INSTALL_NAME: &str = "gaze-agent-state.sh";
const MASTRACODE_HOOK_ASSET: &str = include_str!("assets/mastracode/gaze-agent-state.sh");
...
const GROK_HOOK_INSTALL_NAME: &str = "gaze-agent-state.sh";
const GROK_HOOK_CONFIG_INSTALL_NAME: &str = "gaze.json";
const GROK_HOOK_ASSET: &str = include_str!("assets/grok/gaze-agent-state.sh");
const GROK_INTEGRATION_VERSION: u32 = 1;
const INTEGRATION_VERSION_MARKER: &str = "GAZE_INTEGRATION_VERSION=";
