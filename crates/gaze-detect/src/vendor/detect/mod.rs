...
pub fn session_identity_only_integration(source: &str, agent_label: &str) -> bool {
    (source, agent_label) == ("gaze:hermes", "hermes")
}
...
mod tests {
    ...
    fn hermes_session_integration_leaves_state_to_screen_detection() {
        assert!(!full_lifecycle_hook_authority("gaze:hermes", "hermes"));
        assert!(session_identity_only_integration("gaze:hermes", "hermes"));
    ...
    #[test]
    fn identify_agent_in_job_ignores_gaze_powershell_shell_integration_argv() {
        let job = crate::platform::ForegroundJob {
            process_group_id: 123,
            processes: vec![foreground_process(
                1,
    ...
    #[cfg(target_os = "linux")]
    #[test]
    #[ignore = "gaze stubs out foreground process scanning; it identifies agents from argv"]
