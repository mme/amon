...
// Upstream: https://github.com/ogulcancelik/herdr/blob/095f1337d6502081658973ae3487dee8c6b34e1a/src/integration/opencode_config.rs
...
mod tests {
    ...
    fn add_and_remove_tui_plugin_preserves_jsonc_config() {
        ...
        add_tui_plugin(&dir, "./amon-tui-state.js").unwrap();
        add_tui_plugin(&dir, "./amon-tui-state.js").unwrap();
        ...
        assert!(remove_tui_plugin(&dir, "./amon-tui-state.js").unwrap());
    ...
    fn managed_jsonc_leaves_opencode_migration_target_absent() {
        ...
        let config_path = add_tui_plugin(&dir, "./amon-tui-state.js").unwrap();
    ...
    fn configured_tui_plugin_accepts_option_tuple() {
        ...
        fs::write(
            ...
            r#"{"plugin":[["./amon-tui-state.js",{"enabled":true}]]}"#,
        )
        .unwrap();

        assert!(tui_plugin_is_configured(&dir, "./amon-tui-state.js"));
        assert!(remove_tui_plugin(&dir, "./amon-tui-state.js").unwrap());
