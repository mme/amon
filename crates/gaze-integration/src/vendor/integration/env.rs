...
// Upstream: https://github.com/ogulcancelik/herdr/blob/514e4465ee33d4d81682d06ee2934483982a54ed/src/integration/env.rs
...
pub(crate) const GAZE_AGENT_ID_ENV_VAR: &str = "GAZE_AGENT_ID";
pub(crate) const GAZE_TAB_ID_ENV_VAR: &str = "GAZE_TAB_ID";
pub(crate) const GAZE_WORKSPACE_ID_ENV_VAR: &str = "GAZE_WORKSPACE_ID";
...
pub(crate) fn grok_dir() -> io::Result<PathBuf> {
    // GROK_CONFIG_DIR is a gaze-level override only (primarily a test
