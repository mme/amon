...
// Upstream: https://github.com/ogulcancelik/herdr/blob/514e4465ee33d4d81682d06ee2934483982a54ed/src/terminal/metadata.rs
...
mod tests {
    ...
    fn user_agent_metadata_overrides_presentation_fields_only() {
        ...
        let mutation = terminal.set_agent_metadata(AgentMetadataReport {
            ...
            applies_to_source: Some("gaze:claude".into()),
