...
# Upstream: https://github.com/ogulcancelik/herdr/blob/095f1337d6502081658973ae3487dee8c6b34e1a/src/integration/assets/devin/herdr-agent-state.ps1
...
try {
    & $amon hook report-agent-session $env:AMON_AGENT_ID --source amon:devin --agent devin --seq $seq --agent-session-id $sessionId 2>$null | Out-Null
} catch {
}
